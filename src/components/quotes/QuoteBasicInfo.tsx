      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            <Select
              ...
              inputProps={{
                'aria-label': '고객사 선택',
                'aria-describedby': errors.customer_name_snapshot ? 'customer-error' : undefined,
              }}
            >
              <MenuItem value="">
                <em>직접 입력</em>
        ...
        {!formData.customer_id && (
          <Grid item xs={12} md={6}>
            <TextField
              ...
              onChange={(e) => onUpdate({ customer_name_snapshot: e.target.value })}
              error={!!errors.customer_name_snapshot}
              helperText={errors.customer_name_snapshot}
              required
              inputProps={{
                'aria-label': '고객사명 직접 입력',
                'aria-describedby': errors.customer_name_snapshot ? 'customer-name-error' : undefined,
              }}
            />
          </Grid>
        )}
        ...
        <Grid item xs={12} md={6}>
          <TextField
            ...
            onChange={(e) => onUpdate({ agency_fee_rate: parseFloat(e.target.value) || 0 })}
            inputProps={{ 
              min: 0, 
              max: 100, 
              step: 0.1,
