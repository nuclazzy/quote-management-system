...
const getHandler = withAuth(
  withRateLimit(RateLimitPresets.standard, handleGet)
);

const putHandler = withAuth(
  withRateLimit(
    RateLimitPresets.standard,
    withValidation(CustomerSchema, handlePut)
  )
);

const deleteHandler = withAuth(
  withRateLimit(RateLimitPresets.standard, handleDelete),
