...
export const QuoteCreateUpdateSchema = z.object({
  ...
  issue_date: z
    ...
    .optional(),
  status: z
    .enum(['draft', 'sent', 'accepted', 'revised', 'canceled'])
    .default('draft'),
  ...
  agency_fee_rate: z
    .number()
    .min(0)
    .max(100, '대행수수료율은 0-100% 사이여야 합니다.')
    .default(0),
...
export const QuoteFilterSchema = z.object({
  status: z
    .array(z.enum(['draft', 'sent', 'accepted', 'revised', 'canceled']))
    .optional(),
