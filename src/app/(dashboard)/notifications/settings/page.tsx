...
function SettingCard({ title, description, icon, settings, values, onChange }: SettingCardProps) {
  return (
    <Card>
      <CardContent>
  ...
  return (
    <Box>
      ...
      <Typography variant="body1" color="text.secondary" mb={4}>
        받고 싶은 알림을 설정하세요. 각 카테고리별로 세부적인 알림을 관리할 수 있습니다.
      </Typography>
      ...
      <Paper sx={{ p: 3, mt: 4 }}>
        <Box display="flex" justifyContent="space-between" alignItems="center">
          <Typography variant="body2" color="text.secondary">
            {hasChanges ? '변경 사항이 있습니다.' : '모든 설정이 저장되었습니다.'}
          </Typography>
